...
def balanced(m):
    ...
    if is_weight(end(left(m))) and is_weight(end(right(m))):
        ...
        return balanced(end(right(m))) and torque(left(m)) == torque(right(m))
    elif is_weight(end(right(m))):
        return balanced(end(left(m))) and torque(left(m)) == torque(right(m))
    else:
...
def totals_tree(m):
    ...
    if is_weight(end(left(m))) and is_weight(end(right(m))):
        ...
        return tree(total_weight(m), [totals_tree(end(left(m))), tree(size(end(right(m))))])
    elif is_weight(end(left(m))):
        return tree(total_weight(m), [tree(size(end(left(m)))), totals_tree(end(right(m)))])
    else:
